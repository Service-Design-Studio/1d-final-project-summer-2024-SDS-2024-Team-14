...
const FilePreviewModal = ({ fileObj, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-default bg-opacity-50 z-50 preview_modal">
            <div className="bg-white rounded-lg px-6 max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg w-full relative">
                <button onClick={onClose} className="absolute top-0 right-2 text-red-500 text-2xl close">
                    &times;
                </button>
