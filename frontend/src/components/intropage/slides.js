...
const slides = [
    {
        ...
        imageSm: '/images/intro/phoneref.jpg',
        title: 'Introduction',
    ...
    {
        imageLg: '/images/intro/chatbot.jpg',
        imageSm: '/images/intro/chatbot.jpg',
        title: 'FAQ Chatbot',
