# -*- encoding: utf-8 -*-
# stub: google-cloud-error_reporting-v1beta1 0.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "Groups and counts similar errors from cloud services and applications, reports new errors, and provides access to error groups and their associated errors.".freeze
