# -*- encoding: utf-8 -*-
# stub: google-cloud-trace 0.44.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<google-cloud-trace-v1>.freeze, [">= 0.0".freeze, "< 2.a".freeze])
  s.add_runtime_dependency(%q<google-cloud-trace-v2>.freeze, [">= 0.0".freeze, "< 2.a".freeze])
end
