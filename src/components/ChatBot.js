    ...
    return (
        <>
            <div className="fixed sm:bottom-10 sm:right-10 bottom-4 right-4">
                ...
                >
                    <Image  className="w-[14vw] sm:w-[10vw] lg:w-[3.5vw]" src={chatBot} />
                </button>
                <div className={`bg-white rounded-xl overflow-hidden lg:w-[20vw] lg:h-[30vw] 
                md:w-[55vw] md:h-[65vw] sm:w-[50vw] sm:h-[65vw] w-[80vw] h-[120vw] 
                drop-shadow-lg ${chatState ? "animate-grow" : "hidden"}`}>
                    <div className="bg-darkblue sm:py-3 py-2 flex justify-between items-center">
                        <div className="flex sm:ml-4 ml-2 items-center">
                            {/*Avatar Bot*/}
                            <div className="lg:w-[2.5vw] sm:w-[5.5vw] w-[9.5vw]">
                                <Image src={helpBot} alt="Bot Picture"/>
                            </div>
                            <div className="sm:ml-4 ml-2">
                                <h1 className="lg:text-[0.8vw] sm:text-[2.5vw] text-[4vw] text-white">HelpBot</h1>
                                <div className="text-[#43EE7D] flex items-center space-x-1">
                                    <Image className="lg:w-[0.3vw] sm:w-[0.8vw] w-[1.5vw] inline-block" src={greenDot} />
                                    <span className="lg:text-[0.8vw] sm:text-[1.4vw] text-[3.5vw]">Online</span>
                                </div>
                            </div>
                        </div>
                        <div className="mr-4">
                    ...
                    <div id="chat-feed" className="overflow-y-scroll px-4 sm:py-2 py-1
                     lg:h-[21.5vw] md:h-[37.5vw] sm:h-[43vw] h-[40vh] w-full">
                        <div className="my-2 py-2 px-4 w-3/4 rounded-2xl clear-both bg-[#C6E8FA] float-left text-black">
                            <h4 className="lg:text-[0.8vw] sm:text-[2vw] text-[4vw]">
                    ...
                    <div className="bg-white absolute bottom-0 w-full">
                        ...
                        <div className="flex items-center mx-3 lg:my-3 my-4">
                            <input id='Input' className="placeholder:text-slate-400 placeholder:sm:text-[2vw] placeholder:text-[3.5vw] placeholder:lg:text-[0.7vw]
                            text-slate-400 lg:text-[0.7vw] sm:text-[2vw] text-[3.5vw] bg-[#E8EBF0] w-10/12 rounded-full
                            ...
                            <Image className="ml-2 sm:w-[4vw] w-[6vw] lg:w-[1.6vw]" onClick={handleSendMessage} src={send} alt="Send button"/>
                        </div>
                    </div>
                </div>
            </div>
