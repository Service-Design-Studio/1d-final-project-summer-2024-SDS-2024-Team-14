...
const Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed bottom-24 left-0 right-0 flex justify-center">
      <div className="bg-white rounded-xl py-2 w-3/5 max-w-md relative shadow-xl border-[#B0B0B0]/50 border-2">
        ...
        <div className="space-y-4">
          ...
          <Link href={`/documents/upload`} className="w-full py-2 bg-blue-500 text-black rounded hover:bg-blue-600 flex items-center justify-center">
            <FontAwesomeIcon icon={faFile} className="mr-2" /> {/* File Icon */}
            Files
          </Link>
          <Link href={`/documents/scanner`} className="w-full py-2 bg-blue-500 text-black rounded hover:bg-blue-600 flex items-center justify-center">
