...
export default function ProfilePic(props) {
    return (
        <div className="relative mt-1 md:mt-2 mx-1 md:mx-2 w-fit rounded-2xl">
            {props.verified? <Image className="absolute md:w-8 md:h-8 w-6 h-6 -top-2 -right-2" src={verified}/> : <Image className="absolute md:w-8 md:h-8 w-6 h-6 -top-2 -right-2" src={warning}/>}
