...
export default function Features(props) {
    return (
        <div className="flex flex-col aos-init aos-animate">
            ...
            <a data-aos='fade-left' data-aos-delay='700' href={``}><FeatureCard btnName={"Guiding Video"} img={"/images/homepage/video_icon.svg"} text={"Need help? Click here to see our guiding video for the website"} /></a>
