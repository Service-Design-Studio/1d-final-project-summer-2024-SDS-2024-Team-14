...
export default function FamilyForm(props) {
    ...
    return (
        <div className="flex flex-col rounded-r-2xl w-[30vw] h-full max-w-96 shadow-lg bg-white text-darkblue text-lg font-semibold px-3 overflow-scroll">
            ...
            <div className="flex flex-col items-center my-5">
                <div>
                    <Button className="bg-gray text-white w-fit hover:bg-gray hover:bg-opacity-75 text-center my-1 mx-2" onClick={() => props.setAddNew(false)}>Discard Changes</Button>
                    <Button onClick={() => props.setAddNew(false)} className="bg-darkblue text-white w-fit hover:bg-darkblue hover:bg-opacity-75  text-center my-1 mx-2">
                    <Image width={1} height={1} className="h-0.8 w-auto mr-2 " src={"/images/save_icon.svg"} alt="Save Changes" /> Save Changes</Button>
                </div>

                <Button className="underline text-darkblue my-3" onClick={() => props.setAddNew(false)}>
