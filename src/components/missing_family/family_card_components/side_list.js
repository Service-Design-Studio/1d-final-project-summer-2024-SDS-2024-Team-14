...
export default function SideList(props) {
    return (
        <div className="flex flex-col w-[10vw] h-[100%] rounded-l-2xl bg-white shadow-lg">
                        ...
                        >
                            <div>
                                <div className="flex flex-row">
                                    <Image unoptimized className=" w-[20%] object-cover aspect-square rounded-full mx-3" src={data.src} width={10} height={10} alt="entry image" />
