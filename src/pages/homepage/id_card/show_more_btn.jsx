...
export default function ShowBtn(props) {
    ...
    return (
        <div className="my-6">
            <button className="btn-darkblue" onClick={props.onClick} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} onMouseDown={onMouseEnter} onMouseUp={onMouseLeave}>
