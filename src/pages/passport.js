...
import UploadFile from '../components/passport_upload/upload_file.js';
        ...
        <div className="min-h-screen flex flex-col bg-[url('../../public/images/background/gebirah-bluebg.png')] bg-cover md:px-[12vw] px-[2vw]">
            ...
            <div className='p-4 text-darkblue'>
                <div className="flex flex-row justify-between">
                    ...
                    <p className='md:my-2 text-[4vw] md:text-[1.5vw] my-4'>Upload your passport image here</p>
                    </div>
                    <div className="w-[9vw] mr-[10vw] md:inline-block hidden">
