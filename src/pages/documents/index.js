...
import docManContent from '@/components/modalContent/docman';
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-cover bg-[url('/images/background/gebirah-bluebg.png')]">
        <NaviBar open={open} setOpen={setOpen} tutorialTitle="Document Manager Tutorial" tutorialContent={docManContent} />
        {/* category button row */}
